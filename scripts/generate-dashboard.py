...
def render_build_page(summary: dict, source_dir: str, base_url: str = "") -> str:
    ...
    if base_url:
        ...
        builder_sbom_url = f"{base}/attestation/{tag}/builder-bom.cdx.json"
        ...
        download_rows = (
            ...
            f"  <tr><th>Target SBOM (CycloneDX)</th><td><a href=\"{h(sbom_url)}\">"
            f"bom.cdx.json</a></td></tr>\n"
            f"  <tr><th>Builder SBOM (CycloneDX)</th><td><a href=\"{h(builder_sbom_url)}\">"
            f"builder-bom.cdx.json</a></td></tr>\n"
